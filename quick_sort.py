...
def quick_sort(arr):
    ...
    if len(arr) <= 1:
        ...
        pivot_idx = len(arr) // 2
        pivot = arr[pivot_idx]
        #Swap the elements and leave the pivot in its final position
        #Left side contains elements less or equal to the pivot, right side contains elements greater than the pivot
        ...
        arr_less_sorted = quick_sort(arr_less)
        arr_greater_sorted = quick_sort(arr_greater)
        sorted_arr = arr_less_sorted + [pivot] + arr_greater_sorted
        return sorted_arr
...
print("Time taken for quick sort on random arrays:", time_random)
print("Memory usage for quick sort on random arrays (KB):", memory_random)
...
print("Time taken for quick sort on sorted arrays (ascending):", time_sorted)
print("Memory usage for quick sort on sorted arrays (ascending) (KB):", memory_sorted)
...
print("Time taken for quick sort on sorted arrays (descending):", time_sorted_desc)
print("Memory usage for quick sort on sorted arrays (descending) (KB):", memory_sorted_desc)
...
plt.title('Quick Sort Memory Usage Analysis')
plt.legend()
plt.grid(True, which="both", ls="--")
plt.tight_layout()
plt.show()
